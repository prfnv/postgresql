select * from (select city.name as city, region.name as region,
                      income.ndoc as nd, goods_groups.name as g_group,
                      goods.name as goods,
    ...
    where income.ddate > '01-04-2020' and volume > 10) as foo
order by random()
limit 10